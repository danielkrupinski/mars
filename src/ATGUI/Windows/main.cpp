#include "../../../include/ATGUI/Windows/main.h"
...
void Main::RenderWindow()
{
    ...
    if (ImGui::Begin(XORSTR("Mars"), &Main::showWindow, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_ShowBorders))
    {
